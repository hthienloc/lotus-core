...
struct ReorderPattern {
    std::u32string_view sorted_chars;
    bool has_glide;
    char32_t glide;
    std::u32string_view vowel;
};

constexpr std::array<ReorderPattern, 141> REORDER_PATTERNS = {{
    {U"a", false, 0, U"a"},
    {U"\x0103", false, 0, U"ă"},
    {U"\x00E2", false, 0, U"â"},
    {U"e", false, 0, U"e"},
    ...
    {U"y", false, 0, U"y"},
    {U"ai", false, 0, U"ia"},
    {U"i\x00EA", false, 0, U"iê"},
    {U"au", false, 0, U"ua"},
    {U"u\x00F4", false, 0, U"uô"},
    {U"a\x01B0", false, 0, U"ưa"},
    {U"\x01A1\x01B0", false, 0, U"ươ"},
    {U"y\x00EA", false, 0, U"yê"},
    {U"ay", false, 0, U"ya"},
    {U"ao", false, 0, U"oa"},
    {U"eo", false, 0, U"oe"},
    {U"o\x0103", false, 0, U"oă"},
    {U"u\x00E2", false, 0, U"uâ"},
    {U"u\x00EA", false, 0, U"uê"},
    {U"u\x01A1", false, 0, U"uơ"},
    {U"uy", false, 0, U"uy"},
    {U"ai", false, 0, U"ai"},
    {U"ao", false, 0, U"ao"},
    {U"au", false, 0, U"au"},
    {U"u\x00E2", false, 0, U"âu"},
    {U"ay", false, 0, U"ay"},
    {U"y\x00E2", false, 0, U"ây"},
    {U"eo", false, 0, U"eo"},
    {U"u\x00EA", false, 0, U"êu"},
    {U"iu", false, 0, U"iu"},
    {U"io", false, 0, U"oi"},
    {U"i\x00F4", false, 0, U"ôi"},
    {U"i\x01A1", false, 0, U"ơi"},
    {U"iu", false, 0, U"ui"},
    {U"i\x01B0", false, 0, U"ưi"},
    {U"u\x01B0", false, 0, U"ưu"},
    {U"iu\x00EA", false, 0, U"iêu"},
    {U"uy\x00EA", false, 0, U"yêu"},
    {U"iu\x00F4", false, 0, U"uôi"},
    {U"i\x01A1\x01B0", false, 0, U"ươi"},
    {U"u\x01A1\x01B0", false, 0, U"ươu"},
    {U"ao", true, U'o', U"a"},
    {U"o\x0103", true, U'o', U"ă"},
    {U"o\x00E2", true, U'o', U"â"},
    {U"eo", true, U'o', U"e"},
    {U"o\x00EA", true, U'o', U"ê"},
    {U"io", true, U'o', U"i"},
    {U"oo", true, U'o', U"o"},
    {U"o\x00F4", true, U'o', U"ô"},
    {U"o\x01A1", true, U'o', U"ơ"},
    {U"ou", true, U'o', U"u"},
    {U"o\x01B0", true, U'o', U"ư"},
    {U"oy", true, U'o', U"y"},
    {U"aio", true, U'o', U"ia"},
    {U"io\x00EA", true, U'o', U"iê"},
    {U"aou", true, U'o', U"ua"},
    {U"ou\x00F4", true, U'o', U"uô"},
    {U"ao\x01B0", true, U'o', U"ưa"},
    {U"o\x01A1\x01B0", true, U'o', U"ươ"},
    {U"oy\x00EA", true, U'o', U"yê"},
    {U"aoy", true, U'o', U"ya"},
    {U"aoo", true, U'o', U"oa"},
    {U"eoo", true, U'o', U"oe"},
    {U"oo\x0103", true, U'o', U"oă"},
    {U"ou\x00E2", true, U'o', U"uâ"},
    {U"ou\x00EA", true, U'o', U"uê"},
    {U"ou\x01A1", true, U'o', U"uơ"},
    {U"ouy", true, U'o', U"uy"},
    {U"aio", true, U'o', U"ai"},
    {U"aoo", true, U'o', U"ao"},
    {U"aou", true, U'o', U"au"},
    {U"ou\x00E2", true, U'o', U"âu"},
    {U"aoy", true, U'o', U"ay"},
    {U"oy\x00E2", true, U'o', U"ây"},
    {U"eoo", true, U'o', U"eo"},
    {U"ou\x00EA", true, U'o', U"êu"},
    {U"iou", true, U'o', U"iu"},
    {U"ioo", true, U'o', U"oi"},
    {U"io\x00F4", true, U'o', U"ôi"},
    {U"io\x01A1", true, U'o', U"ơi"},
    {U"iou", true, U'o', U"ui"},
    {U"io\x01B0", true, U'o', U"ưi"},
    {U"ou\x01B0", true, U'o', U"ưu"},
    {U"iou\x00EA", true, U'o', U"iêu"},
    {U"ouy\x00EA", true, U'o', U"yêu"},
    {U"iou\x00F4", true, U'o', U"uôi"},
    {U"io\x01A1\x01B0", true, U'o', U"ươi"},
    {U"ou\x01A1\x01B0", true, U'o', U"ươu"},
    {U"au", true, U'u', U"a"},
    {U"u\x0103", true, U'u', U"ă"},
    {U"u\x00E2", true, U'u', U"â"},
    {U"eu", true, U'u', U"e"},
    {U"u\x00EA", true, U'u', U"ê"},
    {U"iu", true, U'u', U"i"},
    {U"ou", true, U'u', U"o"},
    {U"u\x00F4", true, U'u', U"ô"},
    {U"u\x01A1", true, U'u', U"ơ"},
    {U"uu", true, U'u', U"u"},
    {U"u\x01B0", true, U'u', U"ư"},
    {U"uy", true, U'u', U"y"},
    {U"aiu", true, U'u', U"ia"},
    {U"iu\x00EA", true, U'u', U"iê"},
    {U"auu", true, U'u', U"ua"},
    {U"uu\x00F4", true, U'u', U"uô"},
    {U"au\x01B0", true, U'u', U"ưa"},
    {U"u\x01A1\x01B0", true, U'u', U"ươ"},
    {U"uy\x00EA", true, U'u', U"yê"},
    {U"auy", true, U'u', U"ya"},
    {U"aou", true, U'u', U"oa"},
    {U"eou", true, U'u', U"oe"},
    {U"ou\x0103", true, U'u', U"oă"},
    {U"uu\x00E2", true, U'u', U"uâ"},
    {U"uu\x00EA", true, U'u', U"uê"},
    {U"uu\x01A1", true, U'u', U"uơ"},
    {U"uuy", true, U'u', U"uy"},
    {U"aiu", true, U'u', U"ai"},
    {U"aou", true, U'u', U"ao"},
    {U"auu", true, U'u', U"au"},
    {U"uu\x00E2", true, U'u', U"âu"},
    {U"auy", true, U'u', U"ay"},
    {U"uy\x00E2", true, U'u', U"ây"},
    {U"eou", true, U'u', U"eo"},
    {U"uu\x00EA", true, U'u', U"êu"},
    {U"iuu", true, U'u', U"iu"},
    {U"iou", true, U'u', U"oi"},
    {U"iu\x00F4", true, U'u', U"ôi"},
    {U"iu\x01A1", true, U'u', U"ơi"},
    {U"iuu", true, U'u', U"ui"},
    {U"iu\x01B0", true, U'u', U"ưi"},
    {U"uu\x01B0", true, U'u', U"ưu"},
    {U"iuu\x00EA", true, U'u', U"iêu"},
    {U"uuy\x00EA", true, U'u', U"yêu"},
    {U"iuu\x00F4", true, U'u', U"uôi"},
    {U"iu\x01A1\x01B0", true, U'u', U"ươi"},
    {U"uu\x01A1\x01B0", true, U'u', U"ươu"}
}};
}  // namespace phonology
}  // namespace lotus_core

...
const std::vector<char32_t> INVALID_FINALS_U32 = {
    'b', 'd', 'f', 'g', 'j', 'k', 'l', 'r', 's', 'v', 'x', 'z'
};
...
const std::vector<std::u32string_view> VALID_NUCLEI_U32 = {
    ...
    U"ia", U"iê", U"ua", U"uô", U"ưa", U"ươ", U"yê", U"ya",
    U"oa", U"oe", U"oă", U"uâ", U"uê", U"uơ", U"uy",
    U"ai", U"ao", U"au", U"âu", U"ay", U"ây", U"eo", U"êu", U"iu", U"oi", U"ôi", U"ơi", U"ui", U"ưi", U"ưu",
    U"iêu", U"yêu", U"uôi", U"ươi", U"ươu"};
